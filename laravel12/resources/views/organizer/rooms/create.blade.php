...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="margin-top: 60px;">
            ...
            <form method="POST" action="{{ route('organizer.rooms.store', $event) }}">
                @csrf
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <select class="form-control @error('channel_id') is-invalid @enderror" id="selectChannel" name="channel_id" required>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('capacity') is-invalid @enderror" id="inputCapacity" name="capacity" value="{{ old('capacity') }}" min="1" required>
                        @error('capacity')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
