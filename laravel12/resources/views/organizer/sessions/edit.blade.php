...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="margin-top: 60px;">
            ...
            <form method="POST" action="{{ route('organizer.sessions.update', [$event, $session]) }}">
                @csrf
                @method('PUT')
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="inputTitle" name="title" value="{{ old('title', $session->title) }}" required>
                        @error('title')
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="inputSpeaker" name="speaker" value="{{ old('speaker', $session->speaker) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="inputCost" name="cost" value="{{ old('cost', $session->cost) }}" min="0" step="0.01">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('start') is-invalid @enderror" id="inputStart" name="start" value="{{ old('start', $session->start->format('Y-m-d\TH:i')) }}" required>
                        @error('start')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-12 col-lg-6 mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('end') is-invalid @enderror" id="inputEnd" name="end" value="{{ old('end', $session->end->format('Y-m-d\TH:i')) }}" required>
                        @error('end')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="textareaDescription" name="description" rows="5">{{ old('description', $session->description) }}</textarea>
                    </div>
                </div>
